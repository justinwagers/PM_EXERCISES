...
______
While we do believe that the stats guru may be onto something in that green buildings do usually fetch higher rent rates, we do not believe that his method of simply taking the median of green and non-green buildings is substantial. There are a multitude of factors that he should have taken into account, such as Size, Age, and Class.

From the three variables tested that provided substantial evidence (Size, Age, and Class), they indirectly showed that people paid a premium for green buildings. This does support the stats guru's conclusion that the company could price the rent of a green building at a premium, but we do not believe that these conclusions provide enough evidence to concretely say that any green building can charge a premium. What we did conclude is that the company should focus more on is the overall size of the building and developing one that would be of class A. 
...
While we cannot say with certainty that a building that has a received a green rating equates to being able to charge a premium over non-green rated buildings, we do believe that a further in-depth analysis on other variables should be taken to generate this answer. 